...
class VideoPlayerController extends ValueNotifier<VideoPlayerValue> {
  ...
  VideoPlayerController.asset(this.dataSource,
      {this.package, this.onSinglePlayCompleted, this.closedCaptionFile})
  ...
  VideoPlayerController.network(this.dataSource,
      {this.formatHint, bool useCache = true, this.onSinglePlayCompleted, this.closedCaptionFile})
  ...
  /// `'file://${file.path}'`.
  VideoPlayerController.file(File file, {this.onSinglePlayCompleted, this.closedCaptionFile})
